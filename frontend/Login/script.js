...
const login = async () => {
    ...
    try {
        ...
        const response = await fetch('https://blue-cycle-zljn.onrender.com/api/v1/userAuth', {
            method: 'POST',
            headers: {
...
const checkTemporaryPassword = async (userId, oldPassword) => {
    try {
        const response = await fetch(`https://blue-cycle-zljn.onrender.com/api/v1/users/${userId}`, {
            method: 'GET',
            headers: {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    sendResetEmailButton.addEventListener('click', async () => {
        ...
        try {
            const response = await fetch('https://blue-cycle-zljn.onrender.com/api/v1/forgotPassword', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
